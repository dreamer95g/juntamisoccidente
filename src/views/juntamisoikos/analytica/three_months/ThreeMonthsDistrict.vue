...
export default Vue.extend({
  data: () => {
    return {
      ...
      //atributos propios
      loading: false,
      title: "Informe Trimestral Distrito",
      placeholder: "Iglesia",
      name: "",
      district_name: "",
      district_id: "",
  ...
  methods: {
    ...
    getResults: async function (id, three_selected, year) {
      await this.$apollo
        ...
        .then((data) => {
          //console.log(data.data.threeMonthsDistrict);
          let result = data.data.threeMonthsDistrict;
    ...
    async getId(name) {
      await this.$apollo
        ...
        .then((data) => {
          //console.log(data.data.districtWhere);
          this.district_id = data.data.districtWhere.id;
        })
        .catch((error) => {
          //console.error(error);
          this.notify("error", "Error", "No se encontro ningun elemento");
