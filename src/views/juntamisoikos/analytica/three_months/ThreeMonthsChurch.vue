...
export default {
  data() {
    return {
      ...
      //atributos propios
      loading: false,
      title: "Informe Trimestral Iglesia",
      placeholder: "Iglesia",
      name: "",
      church_name: "",
      church_id: "",
  ...
  methods: {
    ...
    getResults: async function (id, three_selected, year) {
      //alert("Entro a get resu");
      //console.log(id, three_selected, year);
      await this.$apollo
        .query({
          query: gql`
        ...
        .then((data) => {
          //console.log(data.data.threeMonthsChurch);
          let result = data.data.threeMonthsChurch;
    ...
    async getId(name) {
      await this.$apollo
        ...
        .then((data) => {
          //console.log(data.data.churchWhere);
          this.church_id = data.data.churchWhere.id;
        })
        .catch((error) => {
          //console.error(error);
          this.notify("error", "Error", "No se encontro ningun elemento");
