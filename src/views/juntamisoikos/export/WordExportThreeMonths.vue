...
export default {
  data() {
    return {
      //COSAS DEL WORD
      hostUrl: "",
      documentName: "Informe Trimestral",
      documentTitle: "Informe Trimestral",
      iconStyle:
  ...
  mounted() {
    if (
      ...
      this.type_p !== "" &&
      this.name_p !== "" &&
      this.form_data_p !== null
    ) {
      this.title = this.title_p;
      this.type = this.type_p;
      this.name = this.name_p;
      this.form_data = this.form_data_p;
      this.members = this.form_data_p.members;
      this.discipleship = this.form_data_p.discipleship;
      this.kids = this.form_data_p.kids;
      this.teens = this.form_data_p.teens;
      this.youngs = this.form_data_p.youngs;
      this.men = this.form_data_p.men;
      this.ladies = this.form_data_p.ladies;
      this.baptist_family = this.form_data_p.baptist_family;
      this.ministered_lives = this.form_data_p.ministered_lives;

      let month = this.form_data.month;
      ...
      this.$nextTick(function () {
          ...
          sections: [
            {
              ...
              blocks: [
                {
                  paragraphFormat: { styleName: "Heading 1", listFormat: {} },
                  characterFormat: {},
                  inlines: [
                    { characterFormat: {}, text: this.title },
                    {
                      characterFormat: { bidi: false },
                      text: " de " + this.month + " " + this.form_data.year,
                    },
                  ],
                },
                {
                ...
                {
                  paragraphFormat: { styleName: "Heading 2", listFormat: {} },
                  characterFormat: {},
                  inlines: [
                    { characterFormat: {}, text: this.type + ": " },
                    { characterFormat: {}, text: this.name },
                  ],
                },
                {
                  paragraphFormat: { styleName: "Normal", listFormat: {} },
                ...
                },
                {
                  ...
                  inlines: [
                    ...
                    {
                      characterFormat: { bidi: false },
                      text: this.discipleship.toString(),
                    },
                  ],
                },
                {
                ...
                },
                {
                  ...
                  inlines: [
                    {
                      characterFormat: { bold: true, bidi: false },
                      text: "Familia Bautista: ",
                    },
                    {
                      characterFormat: { bidi: false },
                      text: this.baptist_family.toString(),
                    },
                  ],
                },
                {
                ...
                },
                {
                  ...
                  inlines: [
                    {
                      characterFormat: { bold: true, bidi: false },
                      text: "Vidas Ministradas: ",
                    },
                    {
                      characterFormat: { bidi: false },
                      text: this.ministered_lives.toString(),
                    },
                  ],
                },
                {
        ...
        obj.documentName = this.title + " " + this.type + " " + this.name;
        ...
        this.notify(
          "success",
          "Informe Exportado",
          "Informe trimestral exportado de forma exitosa"
        );

        //MANDAR EL EVENTO PARA QUE VUELVA A EXPORTAR, NO ME FUNCIONA
        //this.$emit("show_export", this.show_export);
      });
    } else {
      this.notify(
        "warning",
        "Campos Vacios",
        "Por favor revise nuevamente que todos los campos esten llenos"
      );
    }
  },
